...
public class CommentPushSendService extends BaseService {

    private final FirebaseMessaging firebaseMessaging;
    private final PushService pushService;

    @SqsListener(value = {"${cloud.aws.sqs.push.all.comment.pushSend.listener}", "${cloud.aws.sqs.push.all.comment.pushSend.listener2}", "${cloud.aws.sqs.push.all.comment.pushSend.listener3}"}, deletionPolicy = SqsMessageDeletionPolicy.NO_REDRIVE)
    public void commentSendFcm(@Payload String message) {
